...
import profileFormal from '@/assets/profile-formal2.jpeg';
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 animate-fade-up delay-100">
            <span className="text-gradient">Geethmila</span>
            <br />
            <span className="text-foreground">Jayasooriya</span>
          </h1>
          ...
          <p className="text-muted-foreground mb-10 max-w-xl mx-auto animate-fade-up delay-300">
            Creating impactful applications with React, Node.js, Python, and Firebase — from smart chatbots to cloud apps and AI-powered solutions.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 animate-fade-up delay-500">
            ...
            <a
              href="https://www.linkedin.com/in/geethmila-jayasooriya-27ab1b300/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full border border-border bg-secondary/50 text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 hover:scale-110"
              aria-label="LinkedIn"
            ...
            <a
              href="mailto:geethmilajayasooriya2001@gmail.com"
              className="p-3 rounded-full border border-border bg-secondary/50 text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300 hover:scale-110"
              aria-label="Email"
            >
              <Mail size={20} />
